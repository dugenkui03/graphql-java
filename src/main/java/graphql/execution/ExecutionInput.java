...
public class ExecutionInput {
    ...
    public static class Builder {
        ...
        private Object context = ExecutionInputContext.newContext().build();
        private Object root;
        ...
        /**
         * By default you will get a {@link ExecutionInputContext} object but you can set your own.
         *
        ...
        public Builder context(ExecutionInputContext.Builder contextBuilder) {
            this.context = contextBuilder.build();
            return this;
        }

        public Builder context(UnaryOperator<ExecutionInputContext.Builder> contextBuilderFunction) {
            ExecutionInputContext.Builder builder = ExecutionInputContext.newContext();
