...
import graphql.masker.ThreadSafe;
 ...
 * </pre>
 *
 * You can set this up via {@link ExecutionInput.Builder#context(ExecutionInputContext.Builder)}
 */
@PublicApi
@ThreadSafe
@SuppressWarnings("unchecked")
public class ExecutionInputContext {
    private final ConcurrentMap<Object, Object> map;

    private ExecutionInputContext(ConcurrentMap<Object, Object> map) {
        this.map = map;
    }
    ...
    public void putAll(ExecutionInputContext context) {
    ...
    public static class Builder {
        ...
        public ExecutionInputContext build() {
            return new ExecutionInputContext(map);
        }
    }
}
