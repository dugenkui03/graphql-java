package graphql.language.operation;
...
public class AstValueHelper {
    ...
    /**
     * Parses an AST value literal into the correct {@link Value} which
     ...
     * @throws AssertException if the input can be parsed
     */
    public static Value<?> valueFromAst(String astLiteral) {
        ...
        try {
            Document doc = new DocumentParser().parseDocument(toParse);
